 ...
 * @author user
 */
 class VentanaGestionTelefono extends javax.swing.JInternalFrame {
    ...
    public void  cargarTelefonosTblTelefonos(){
        ...
        for(int i = 0; i<controladorUsuario.listarTelefonos().size();i++){
           telefono =  controladorUsuario.listarTelefonos().get(i);
...
//    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
         telefono = new Telefono(Integer.parseInt(txtCodigo.getText()),
                txtNumero.getValue()+"", cbxTipo.getSelectedItem().toString(),
                cbxOperadora.getSelectedItem().toString());
...
//        cargarTelefonosTblTelefonos();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        controladorUsuario.actualizarTelefono(Integer.parseInt(txtCodigo.getText()), txtNumero.getText(),
                cbxTipo.getSelectedItem().toString(),  cbxOperadora.getSelectedItem().toString());
        cargarTelefonosTblTelefonos();
        limpiar();
        desactivarEdicion();
    ...
    public void limpiar(){
        txtCodigo.setText(Integer.parseInt((txtCodigo.getText())+1)+"");
        txtNumero.setValue("");
